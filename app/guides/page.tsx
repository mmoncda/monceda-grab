...
export const metadata: Metadata = { title: "Responsible Media Guides — Monceda Grab", description: "Original practical guides about saving public media responsibly, file quality, permission, and privacy." };
